...
class CreateNewPasswordScreenBloc {
  ...
  Future<void> createNewPassword(String email, String token, String password,
    ...
    await dio
        ...
        .then((value) => {
              stateSubject
                  .add(CreateNewPasswordScreenState.createNewPasswordSuccess)
            })
        .catchError((onError) => {
              if (onError.response.statusCode == 400)
                {
                  ...
                  stateSubject
                      .add(CreateNewPasswordScreenState.createNewPasswordError)
                }
              else
                {
                  errorMessage =
