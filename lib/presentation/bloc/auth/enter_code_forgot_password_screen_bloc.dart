...
class EnterCodeForgotPasswordScreenBloc {
  ...
  Future<void> sendEmailCode(String email, String code) async {
    ...
    await dio
        ...
        .then((value) => {
              ...
              stateSubject
                  .add(EnterCodeForgotPasswordScreenState.sendEmailCodeSuccess)
            })
        .catchError((onError) => {
              if (onError.response.statusCode == 400)
                {
                  ...
                  stateSubject.add(
                      EnterCodeForgotPasswordScreenState.sendEmailCodeError)
                }
              else
                {
                  errorMessage =
  ...
  Future<void> sendRepeatCode(String email) async {
    ...
    await dio
        ...
        .then((value) => {
              stateSubject
                  .add(EnterCodeForgotPasswordScreenState.sendEmailCodeScreen)
            })
        .catchError((onError) => {
