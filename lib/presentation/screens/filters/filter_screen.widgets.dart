  ...
  Widget build(BuildContext context) {
    return SliderTheme(
      data: SliderTheme.of(context).copyWith(
        rangeThumbShape: const _Thumb(),
        rangeTrackShape: _Track(),
      ),
      child: RangeSlider(
        max: 1000000,
        values: RangeValues(_firstX, _secondX),
        activeColor: const Color(0xff6CC9E0),
...
class _Track extends RoundedRectRangeSliderTrackShape {
  ...
  Rect getPreferredRect({
    ...
    final double trackRight =
        trackLeft * 3 + parentBox.size.width - overlayWidth;
        ...
        child: InkWell(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              borderRadius: BorderRadius.circular(10.0),
              color: isSelected ? Colors.white : const Color(0xffFCFCFC),
...
class AppRadioButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        border: Border.all(
          color: isSelected ? const Color(0xff6CC9E0) : const Color(0xffAAAAAA),
        ),
...
class _BottomBarItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SvgPicture.asset(
      ...
      height: 24.0,
      color: isSelected
          ? const Color(0xff6CC9E0)
          : const Color(0xff1B877E).withOpacity(0.5),
    );
  }
}
